...
<div class="global clear">
  ...
  <div class="mainBox">
    <div class="loc clear">
      <div class="position"> <span>您的位置：</span> 
      	<a href="<?php echo Yii::app()->homeUrl?>">首页</a> 
      	<em></em> <a href="<?php echo $this->createUrl('post/index', array('catalog'=>$catalogTopArr['catalog_name_alias'] ))?>"><?php echo $catalogTopArr['catalog_name'];?></a> 
